...
#(define Henle-scripts '(
   ("staccato" . ((outside-staff-padding . 0.4)))
...
\paper {
  ...
  scoreTitleMarkup = \markup \fill-line {
    \override #'(baseline-skip . 3.5) \center-column {
      \abs-fontsize #26 \fromproperty #'header:title
      \when-property #'header:dedication \abs-fontsize #11.75 \italic \fromproperty #'header:dedication
      \when-property #'header:date \abs-fontsize #9.5 \line { "Komponiert" \fromproperty #'header:date }
      \when-property #'header:opus \vspace #0.5 \abs-fontsize #9.5 \fill-line { "" \fromproperty #'header:opus }
    }
  }
}
